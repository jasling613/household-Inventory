...
var useNow = (timezone) => {
  const adapter = usePickerAdapter();
  const now = React5.useRef(void 0);
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React6.useMemo(() => _extends({}, internalProps, validationProps, {
...
var PickerPopperPaperWrapper = React8.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const ownerState = React8.useMemo(() => _extends({}, pickerOwnerState, {
...
function useValueAndOpenStates(parameters) {
  ...
  } = React12.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React12.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React12.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React13.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React13.useState(null);
  const popupRef = React13.useRef(null);
  const fieldRef = React13.useRef(null);
  const rootRefObject = React13.useRef(null);
  ...
  const ownerState = React13.useMemo(() => ({
  ...
  const triggerStatus = React13.useMemo(() => {
  ...
  const contextValue = React13.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React13.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React13.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React14.memo(PickersActionBarComponent);
...
var PickersLayout = React16.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React16.Fragment, {
...
var useFieldState = (parameters) => {
  ...
  const sectionsValueBoundaries = React17.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  ...
  const hasPartiallyFilledSectionsOnBlur = React17.useMemo(() => {
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React21.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React21.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const domGetters = React22.useMemo(() => ({
...
function PickersSection(props) {
  ...
  return (0, import_jsx_runtime10.jsxs)(Section, _extends({}, sectionProps, {
    children: [(0, import_jsx_runtime10.jsx)(SectionSeparator, _extends({}, sectionSeparatorBeforeProps)), (0, import_jsx_runtime10.jsx)(SectionContent, _extends({}, sectionContentProps, {
      ref: handleSectionContentRef,
      onBlur: handleContentBlur
    })), (0, import_jsx_runtime10.jsx)(SectionSeparator, _extends({}, sectionSeparatorAfterProps))]
  }));
}
...
var PickersOutlinedInput = React31.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime13.jsx)(Outline, {
      ...
      label: label != null && label !== "" && muiFormControl?.required ? (0, import_jsx_runtime13.jsxs)(React31.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime29.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime29.jsx)(Field, _extends({}, fieldProps, {
      slots: _extends({}, slots, fieldProps.slots),
      slotProps: _extends({}, slotProps, fieldProps.slotProps),
      inputRef
    })), (0, import_jsx_runtime29.jsx)(PickersModalDialog, {
      slots,
      slotProps,
      children: (0, import_jsx_runtime29.jsx)(Layout, _extends({}, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
var _excluded33 = ["desktopModeMediaQuery"];
var DatePicker = React51.forwardRef(function DatePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime30.jsx)(DesktopDatePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime30.jsx)(MobileDatePicker, _extends({
    ref
  }, other));
});
